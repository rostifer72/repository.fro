...
if __name__ == '__main__':
    ...
    if params['vid_type'] == 'movie':
        watched_params = {"mode": "mark_movie_as_watched_unwatched", "action": 'mark_as_unwatched',
        "media_id": meta['tmdb_id'], "title": meta['title'], "year": meta['year']}
    else:
        watched_params = {"mode": "mark_episode_as_watched_unwatched", "action": 'mark_as_unwatched',
