...
default_icon = kodi_utils.translate_path('special://home/addons/script.tikiart/resources/media/discover.png')
...
class Discover:
	...
	def similar_recommended(self):
		...
		for item in results:
			...
			else: icon = kodi_utils.translate_path('special://home/addons/script.tikiart/resources/media/box_office.png')
	...
	def cast(self):
		...
		if len(result) > 1:
			for item in result:
				...
				else: icon = kodi_utils.translate_path('special://home/addons/script.tikiart/resources/media/genre_family.png')
