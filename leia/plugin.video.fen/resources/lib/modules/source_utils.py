...
from modules.settings import ext_addon, date_offset
...
os_data_path = translate_path('special://profile/addon_data/script.module.fenomscrapers/')
os_addon_dir = translate_path('special://home/addons/script.module.fenomscrapers/')
