...
from modules.nav_utils import hide_busy_dialog, close_all_dialog, notification, volume_checker, translate_path, sleep, execute_builtin
...
class FenPlayer(xbmc.Player):
	...
	def nextEpPrep(self):
		...
		self.nextep_info = nextep_playback_info(self.meta['tmdb_id'], int(self.meta['season']), int(self.meta['episode']))
