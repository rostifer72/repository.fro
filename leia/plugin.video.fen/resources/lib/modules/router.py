...
def routing(argv):
	...
	if 'navigator.' in mode:
		...
		elif mode == 'unaired_color_choice':
			dialogs.unaired_color_choice()
		...
		elif mode == 'results_choice':
			dialogs.results_choice()
	...
	##EXTRA modes##
		...
		show_text(params.get('heading'), params.get('text'), params.get('file'))
