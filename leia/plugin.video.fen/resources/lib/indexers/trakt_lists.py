...
from modules.nav_utils import build_url, setView, add_dir, translate_path, sleep, external_browse
...
def build_trakt_list(params):
	...
	try:
		...
		if total_pages > 2 and not is_widget: _add_misc_dir({'mode': 'build_navigate_to_page', 'db_type': 'Media', 'user': user, 'slug': slug, 'current_page': page_no, 'total_pages': total_pages, 'transfer_mode': 'trakt.list.build_trakt_list'}, ls(32964), 'item_jump.png')
